    ...
    public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws IllegalClassFormatException {
        ...
        while (listIterator.hasPrevious()) {
            ...
            if (className.equals(retransformEntry.getClassName())) {
                ...
                || retransformEntry.getHashCode() != null) updateFlag = isLoaderMatch(retransformEntry, loader);else updateFlag = true;
            }
            ...
            logger.info(
            "RetransformCommand match class: {}, id: {}, classLoaderClass: {}, hashCode: {}", className, id, retransformEntry.getClassLoaderClass(), retransformEntry.getHashCode());
